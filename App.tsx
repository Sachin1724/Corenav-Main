    ...
    return (
      <div className="min-h-screen bg-[#000000] flex flex-col items-center justify-center">
        ...
        <div className="text-center">
          ...
          <p className="text-[10px] uppercase tracking-[1.2em] text-[#FFC700] font-black italic">Deep-Tech Autonomy</p>
        </div>
        <style>{`
          @keyframes loading {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white selection:gold-bg selection:text-black overflow-x-hidden">
      ...
      <motion.main 
        ...
        style={{ rotateX, scale, translateZ, perspective: '2000px' }}
      >
        {view === 'landing' && (
          <>
        ...
        {view === 'about' && (
          <section className="py-24 px-6 max-w-4xl mx-auto text-center">
             ...
             <p className="text-gray-500 leading-relaxed max-w-2xl mx-auto">
               CoreNav is a deep-tech automation and navigation company focused on building intelligent systems that can navigate, operate, and make decisions autonomously across multiple platforms.
             </p>
          </section>
        )}
      </motion.main>
      ...
      {/* Footer */}
      <footer className="bg-black text-white py-32 px-10">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-20">
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-400 text-[11px] font-black uppercase tracking-[0.2em] leading-relaxed max-w-xs mb-10 italic">
                CoreNav builds intelligent navigation systems for autonomous machines. 
                Surgical precision for the robotics age.
              </p>
              <div className="flex space-x-6 text-gray-400">
                <span className="hover:text-[#FFC700] cursor-pointer transition-colors"><Mail className="w-5 h-5" /></span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-12 lg:col-span-3">
              <div>
                <h5 className="text-[10px] font-bold uppercase tracking-[0.4em] mb-10 text-gray-400">Products</h5>
                <ul className="text-gray-500 space-y-4 text-[9px] uppercase tracking-[0.3em]">
                  <li className="hover:text-white cursor-pointer transition-colors duration-500">Multi Rotor Motors</li>
                  <li className="hover:text-white cursor-pointer transition-colors duration-500">Fixed Wing Motors</li>
                  <li className="hover:text-white cursor-pointer transition-colors duration-500">Foldable CFRP</li>
                  <li className="hover:text-white cursor-pointer transition-colors duration-500">BEC/DC-DC Converters</li>
                  <li className="hover:text-white cursor-pointer transition-colors duration-500">Power Distribution</li>
                </ul>
              </div>
              <div>
          ...
          <div className="mt-32 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <button className="bg-white text-black px-10 py-3 text-[10px] font-bold uppercase tracking-widest hover:orange-bg hover:text-white transition-all duration-500 rounded-sm">
              Reach Out To Us
            </button>
          </div>
        </div>
